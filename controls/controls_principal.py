...
class ControlsPrincipal:
    ...
    def ajouter_joueur(self):
        ...
        nom = self.menu.demander_information("Nom du joueur :")
        prenom = self.menu.demander_information("Prénom du joueur :")
        date_de_naissance = self.menu.demander_information("Date de naissance (JJ/MM/AAA) :")
        id_nationale = self.menu.demander_information("ID nationale: ( ex: AA111) :")
    ...
    def generer_classement(self):
        ...
        self.controls_tournois.tournoi.classement = [(joueur.nom, joueur.prenom, joueur.score)
